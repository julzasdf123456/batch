            ...
            <thead>
                <tr>
                    ...
                    <th style="font-size: .68em !important;" class="text-center"
                        ...
                        {{ $gradingPeriod === 'All' ? 'WHOLE SEMESTER' : strtoupper($gradingPeriod) . ' SEMESTER' }}
                    </th>
                        ...
                        @if ($subject['Visibility'] === 'FREAKING PARENT')
                            ...
                            @if (in_array($subject['Subject'], $avgParents))
                                ...
                                @elseif ($gradingPeriod === 'All')
                                    ...
                                    <td class='text-center'>
                                        <strong>{{ $hasInc ? '' : Subjects::validateGrade($subject['AverageGrade']) }}</strong>
                                    </td>
                                @endif
                        ...
                        @foreach ($groupedSubjects[$subject['Subject']] as $subSubject)
                            ...
                            <tr>
                                ...
                                @elseif ($gradingPeriod === 'All')
                                    ...
                                    <td class='text-center'>
                                        <strong>{{ $hasInc ? '' : Subjects::validateGrade($subSubject['AverageGrade']) }}</strong>
                                    </td>
                                @endif
                                <td class='text-center'>
