...
<div id="print-area" class="content">
    ...
    <div class="thirty" style="float: left;">
        <div class="figure-data">
            {{-- TUITION --}}
            <p style='font-size: 1.1em !important; font-family: sans-serif !important; font-stretch: condensed !important; padding-top: 60px !important; padding-left: 140px !important; text-align: left !important;'>{{ is_numeric($transaction->TotalAmountPaid) ? number_format($transaction->TotalAmountPaid, 2) : $transaction->TotalAmountPaid }}</p>

            {{-- TOTAL --}}
            <p style='font-size: 1.1em !important; font-family: sans-serif !important; font-stretch: condensed !important; padding-top: 200px !important; padding-left: 140px !important; text-align: left !important;'>{{ is_numeric($transaction->TotalAmountPaid) ? number_format($transaction->TotalAmountPaid, 2) : $transaction->TotalAmountPaid }}</p>
        </div>
    </div>
