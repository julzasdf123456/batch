...
<div id="print-area" class="content">
    ...
    <div>
        ...
        <p class="text-center" style="margin-top: 10px;"><strong>STUDENTS LIST {{ $class != null ? (strtoupper(' for ' . $class->Year . ' ' . $class->Section)) : '' }}</strong></p>
        @if ($class != null && $class->Strand != null)
    ...
    {{-- female --}}
    <div style="margin-top: 16px;">
        <p class="text-muted" style="margin: 5px 0px 5px 0px;">Female Students</p>
        <table class="table">
            <thead>
                <th></th>
                <th>LRN</th>
