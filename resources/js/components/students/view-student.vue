<template>
          ...
          <div class="card-body p-0">
            <div class="row">
              ...
              <div class="col-lg-4" style="padding: 25px 35px 15px 35px">
                ...
                <span class="badge bg-warning ico-tab-left-mini" title="From what school"
                  >From {{ studentData.FromSchool }} School</span
                >
                ...
                <table class="table table-sm table-borderless" style="margin-top: 18px">
                  <tbody>
                    <tr title="Current Address">
                      ...
                      <td>
                        {{
                          (isNull(studentData.Sitio) ? "" : studentData.Sitio) +
                          ", " +
                          studentData.BarangaySpelled +
                          ", " +
                          studentData.TownSpelled
                        }}
                        ({{ studentData.ZipCode }})
                      </td>
                    </tr>
                    <tr title="Permanent Address">
                      ...
                      <td>
                        {{
                          (isNull(studentData.PermanentSitio)
                            ? ""
                            : studentData.PermanentSitio) +
                          ", " +
                          studentData.BarangaySpelledPermanent +
                          ", " +
                          studentData.TownSpelledPermanent
                        }}
                    ...
                    <tr title="Birthday">
                      ...
                      <td>
                        {{
                          isNull(studentData.Birthdate)
                            ? "not recorded"
                            : moment(studentData.Birthdate).format("MMMM DD, YYYY")
                        }}
                      </td>
                    </tr>
                    <tr title="Contact Numbers">
                      ...
                      <td>
                        {{
                          isNull(studentData.ContactNumber)
                            ? "-"
              ...
              <!-- TABS -->
              <div
                class="col-lg-8 {{ $colorProf != null ? 'bl-dark' : 'bl-light' }}"
                style="
                  padding-top: 15px;
                  padding-bottom: 15px;
                  padding-left: 25px;
                ...
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a
                      ...
                      id="scholarship-tab"
                      data-toggle="pill"
                      href="#scholarship-content"
                      role="tab"
                      aria-controls="scholarship-content"
                      aria-selected="false"
                      >Scholarship Grants</a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                ...
                <div class="tab-content" id="custom-tabs-three-tabContent">
                    ...
                    <div class="p-2 table-responsive">
                      ...
                      <div class="row mt-3">
                        <div class="col-lg-6">
                          ...
                          <span class="text-muted"
                            >Unpaid tuition fees, enrollment fees, and other
                            payments</span
                          >
                        </div>
                        <div class="col-lg-6">
                          <p
                            class="no-pads text-right"
                            :class="
                      ...
                      <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                        <li class="nav-item">
                          <a
                            class="nav-link active"
                            id="payable-history-tab"
                            data-toggle="pill"
                            href="#payable-history-content"
                            role="tab"
                            aria-controls="payable-history-content"
                            aria-selected="false"
                            >Payable History</a
                          >
                        </li>
                        <li class="nav-item">
                          <a
                            ...
                            data-toggle="pill"
                            href="#transaction-history-content"
                            role="tab"
                        ...
                        <li class="nav-item">
                          <a
                            class="nav-link"
                            id="detailed-transactions-tab"
                            data-toggle="pill"
                            href="#detailed-transactions-content"
                            role="tab"
                            aria-controls="detailed-transactions-content"
                            aria-selected="false"
                      ...
                      <div class="tab-content" id="custom-tabs-three-tabContent">
                        ...
                        <div
                          class="tab-pane fade active show"
                          id="payable-history-content"
                          role="tabpanel"
                          aria-labelledby="payable-history-tab"
                        >
                          <table class="table table-sm table-hover">
                            ...
                            <tbody>
                              ...
                              >
                                <td
                                  @click="transactionHistory(payable.id)"
                                  class="v-align"
                                >
                                  {{ payable.PaymentFor }}
                                </td>
                                ...
                                >
                                  <strong>{{
                                    isNull(payable.AmountPayable)
                                      ? "0"
                                      : toMoney(parseFloat(payable.AmountPayable))
                                  }}</strong>
                                </td>
                                <td
                                  @click="transactionHistory(payable.id)"
                                ...
                                >
                                  {{
                                    isNull(payable.AmountPaid)
                                      ? "0"
                                      : toMoney(parseFloat(payable.AmountPaid))
                                  }}
                                </td>
                                <td
                                  @click="transactionHistory(payable.id)"
                                  class="v-align text-right"
                                  :class="
                                    parseFloat(payable.Balance) > 0
                                      ? 'text-danger'
                                      : 'text-success'
                                  "
                                >
                                  <strong>{{
                                    isNull(payable.Balance)
                                      ? "0"
                                      : toMoney(parseFloat(payable.Balance))
                                  }}</strong>
                                </td>
                              </tr>
                            </tbody>
                        ...
                        <div
                          class="tab-pane fade"
                          id="transaction-history-content"
                          role="tabpanel"
                          ...
                          <div class="table-responsive">
                            <table class="table table-hover table-sm table-bordered">
                              ...
                              <tbody>
                                ...
                                >
                                  <td @click="showTransactionDetails(item.id)">
                                    {{ moment(item.ORDate).format("MMM DD, YYYY") }}
                                  </td>
                                  <td @click="showTransactionDetails(item.id)">
                                    {{ item.PaymentFor }}
                                  </td>
                                  ...
                                  <td
                                    @click="showTransactionDetails(item.id)"
                                    class="text-success text-right"
                                  >
                                    <strong>{{
                                      toMoney(parseFloat(item.TotalAmountPaid))
                                    }}</strong>
                                  </td>
                                  <td @click="showTransactionDetails(item.id)">
                                    {{ item.name }}
                        ...
                        <div
                          class="tab-pane fade"
                          id="detailed-transactions-content"
                          role="tabpanel"
                          aria-labelledby="detailed-transactions-tab"
                        >
                          <div class="table-responsive">
                            <table class="table table-hover table-sm table-bordered">
                              <thead>
                              ...
                              <tbody>
                                <tr v-for="item in detailedTransactions" :key="item.id">
                                  ...
                                  <td class="text-right text-success">
                                    <strong>{{
                                      toMoney(parseFloat(item.Amount))
                                    }}</strong>
                                  </td>
                                  <td>{{ item.name }}</td>
                                </tr>
                  ...
                  >
                    <div class="d-flex justify-content-end">
                      <a
                        :href="baseURL + '/students/classes-history/' + studentId"
                        class="btn btn-primary m-2"
                        >Student Class History</a
                      >

                      <a
                        :href="
                          baseURL + '/classes/transfer-to-another-class/' + studentId
                        "
                        class="btn btn-primary m-2"
                        >Transfer to Another Section/Strand</a
                      >
                    </div>

                    <div class="p-2 table-responsive">
                      <p class="text-muted mt-3">
                        <i class="fas fa-dot-circle ico-tab-mini"></i>Current/Latest
                        Subjects Taken in this Class ({{
                          isNull(studentData.Year)
                            ? "-"
                            : studentData.Year + " - " + studentData.Section
                        }})
                      ...
                      <table class="table table-sm table-hover table-borderless">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="v-align">
                              {{ studentData.PSABirthCertificateNumber }}
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td class="v-align">
                              {{
                                isNull(studentData.Indigenousity)
                                  ? "-"
                                  : studentData.Indigenousity
                              }}
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td class="v-align">
                              {{
                                isNull(studentData.Beneficiary4PsIDNumber)
                                  ? "-"
                                  : studentData.Beneficiary4PsIDNumber
                              }}
                            </td>
                          </tr>
                          <tr>
                            <td colspan="2" class="text-muted text-center">
                              <i>Parent/Guardian Information</i>
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td class="v-align">
                              {{
                                validateNullStrings(studentData.FatherFirstName) +
                                " " +
                                validateNullStrings(studentData.FatherMiddleName) +
                                " " +
                                validateNullStrings(studentData.FatherLastName) +
                                " " +
                                validateNullStrings(studentData.FatherSuffix)
                              }}
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td class="v-align">
                              {{
                                validateNullStrings(studentData.MotherFirstName) +
                                " " +
                                validateNullStrings(studentData.MotherMiddleName) +
                                " " +
                                validateNullStrings(studentData.MotherLastName) +
                                " " +
                                validateNullStrings(studentData.MotherSuffix)
                              }}
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td class="v-align">
                              {{
                                validateNullStrings(studentData.GuardianFirstName) +
                                " " +
                                validateNullStrings(studentData.GuardianMiddleName) +
                                " " +
                                validateNullStrings(studentData.GuardianLastName) +
                                " " +
                                validateNullStrings(studentData.GuardianSuffix)
                              }}
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td class="v-align">
                              {{ studentData.ElementarySchoolGraduated }}
                            </td>
                          </tr>
                          <tr>
                            <td class="text-muted v-align">Elementary School Address</td>
                            <td class="v-align">
                              {{ studentData.ElementarySchoolAddress }}
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td class="v-align">
                              {{
                                isNull(studentData.ElementaryDateGraduated)
                                  ? ""
                                  : moment(studentData.ElementaryDateGraduated).format(
                                      "MMMM DD, YYYY"
                                    )
                              }}
                            </td>
                          ...
                          <tr>
                            ...
                            <td class="v-align">
                              {{
                                isNull(studentData.JHSDateGraduated)
                                  ? ""
                                  : moment(studentData.JHSDateGraduated).format(
                                      "MMMM DD, YYYY"
                                    )
                              }}
                            </td>
                        ...
                        <tbody>
                          <tr v-for="scholarship in scholarships" :key="scholarship.id">
                            ...
                            <td class="text-right v-align">
                              {{ toMoney(parseFloat(scholarship.Amount)) }}
                            </td>
                            <td class="v-align">{{ scholarship.DeductMonthly }}</td>
                            <td class="text-right v-align">
                              <button
                                @click="removeScholarship(scholarship.id)"
                                class="btn btn-sm btn-danger"
                              >
                                <i class="fas fa-times ico-tab-mini"></i>Remove
                              </button>
                            </td>
                          </tr>
                        </tbody>
  ...
  <div class="right-bottom">
    <a
      :href="baseURL + '/students/scout/prev/' + studentId"
      class="btn-floating shadow btn-default"
      title="Previous student in this class"
      ><i class="fas fa-backward"></i
    ></a>
    <a
      :href="baseURL + '/students/scout/next/' + studentId"
      class="btn-floating shadow btn-default ml-2"
      title="Next student in this class"
          ...
          <div>
            <div class="row">
              ...
              <div class="col-lg-12 mb-2">
                <div class="row">
                  <div class="col-lg-6">
                    <p class="text-muted text-sm no-pads">
                      Net Amount Payable <i class="fas fa-eye"></i>
                    </p>
                    <h1 class="text-primary">
                      ₱
                      {{
                        isNull(activePayable.AmountPayable)
                          ? "-"
                          : toMoney(parseFloat(activePayable.AmountPayable))
                      }}
                    </h1>
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <p class="text-muted text-sm no-pads">
                          Payable <i class="fas fa-plus-circle"></i>
                        </p>
                        <h4 class="text-muted">
                          ₱
                          {{
                            isNull(activePayable.Payable)
                              ? "-"
                              : toMoney(parseFloat(activePayable.Payable))
                          }}
                        </h4>
                      </div>
                      ...
                      <div class="col-lg-6">
                        <p class="text-muted text-sm no-pads">
                          Discount <i class="fas fa-minus-circle"></i>
                        </p>
                        <h4 class="text-muted">
                          ₱
                          {{
                            isNull(activePayable.DiscountAmount)
                              ? "-"
                              : toMoney(parseFloat(activePayable.DiscountAmount))
                          }}
                        </h4>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-6">
                    <p class="text-muted text-right text-sm no-pads">
                      Balance <i class="fas fa-dollar-sign"></i>
                    </p>
                    <h1
                      class="text-right"
                      :class="
                        isNull(activePayable.Balance)
                          ? 'text-success'
                          : activePayable.Balance <= 0
                          ? 'text-success'
                          : 'text-danger'
                      "
                    >
                      ...
                      {{
                        isNull(activePayable.Balance)
                          ? "0.00"
                          : toMoney(parseFloat(activePayable.Balance))
                      }}
                    </h1>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <p class="text-muted text-right text-sm no-pads">
                          Total Amount Paid <i class="fas fa-check-circle"></i>
                        </p>
                        <h4 class="text-muted text-right">
                          ₱
                          {{
                            isNull(activePayable.AmountPaid)
                              ? "-"
                              : toMoney(parseFloat(activePayable.AmountPaid))
                          }}
                        </h4>
                      </div>
                    </div>
              ...
              <div class="col-lg-12 pb-2">
                <button @click="printTuitionLedger()" class="btn btn-default btn-xs">
                  <i class="fas fa-print ico-tab-mini"></i>Print Tuition Ledger
                </button>
                ...
                <table class="table table-sm table-hover">
                  ...
                  <tbody>
                    <tr v-for="inc in payableInclusions" :key="inc.id">
                      <td class="v-align">
                        <i class="fas fa-check text-success ico-tab-mini"></i
                        >{{ inc.ItemName }}
                      </td>
                      <td class="v-align text-right">
                        {{ toMoney(parseFloat(inc.Amount)) }}
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table class="table table-hover table-sm table-bordered">
                  ...
                  <tbody>
                    <tr v-for="item in tuitionsBreakdown" :key="item.id">
                      <td>
                        <i
                          v-if="parseFloat(item.Balance) <= 0"
                          class="fas fa-check-circle text-success ico-tab-mini"
                        ></i>
                        <i
                          v-if="parseFloat(item.Balance) > 0"
                          class="fas fa-info-circle text-muted ico-tab-mini"
                        ></i>
                      ...
                      <td class="text-right">
                        {{
                          isNull(item.Discount) ? "-" : toMoney(parseFloat(item.Discount))
                        }}
                      </td>
                      <td class="text-right">
                        {{
                          isNull(item.AmountPayable)
                            ? "-"
                            : toMoney(parseFloat(item.AmountPayable))
                        }}
                      </td>
                      <td class="text-right">
                        {{
                          isNull(item.AmountPaid)
                            ? "-"
                            : toMoney(parseFloat(item.AmountPaid))
                        }}
                      </td>
                      <td
                        class="text-right"
                        :class="
                          parseFloat(item.Balance) > 0 ? 'text-danger' : 'text-success'
                        "
                      >
                        <strong>{{ toMoney(parseFloat(item.Balance)) }}</strong>
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <table class="table table-hover table-sm table-bordered">
              ...
              <tbody>
                <tr v-for="hist in payableTransactionHistory" :key="hist.id">
                  ...
                  <td class="v-align">
                    {{
                      hist.ORDate.length < 1
                        ? "-"
                        : moment(hist.ORDate).format("MMM DD, YYY")
                    }}
                  </td>
                  <td class="v-align">{{ hist.name }}</td>
                  <td class="v-align text-right">
                    {{
                      isNull(hist.CashAmount) ? "-" : toMoney(parseFloat(hist.CashAmount))
                    }}
                  </td>
                  <td class="v-align text-right">
                    {{
                      isNull(hist.CheckAmount)
                        ? "-"
                        : toMoney(parseFloat(hist.CheckAmount))
                    }}
                  </td>
                  <td class="v-align text-right">
                    {{
                      isNull(hist.DigitalPaymentAmount)
                        ? "-"
                        : toMoney(parseFloat(hist.DigitalPaymentAmount))
                    }}
                  </td>
                  <td class="v-align text-right">
                    <strong>{{
                      isNull(hist.TotalAmountPaid)
                        ? "-"
                        : toMoney(parseFloat(hist.TotalAmountPaid))
                    }}</strong>
                  </td>
                </tr>
              </tbody>
            ...
            <table class="table table-hover table-sm table-bordered">
              ...
              <tbody>
                <tr v-for="log in updateLogs" :key="log.id">
                  <td class="v-align">
                    {{
                      log.created_at.length < 1
                        ? "-"
                        : moment(log.ORDate).format("MMM DD, YYYY HH:mm A")
                    }}
                  </td>
                  <td class="v-align">{{ log.name }}</td>
                  <td class="v-align text-right">
                    {{
                      isNull(log.OGTotalPayable)
                        ? "-"
                        : toMoney(parseFloat(log.OGTotalPayable))
                    }}
                  </td>
                  <td class="v-align text-right">
                    {{
                      isNull(log.OGPaidAmount)
                        ? "-"
                        : toMoney(parseFloat(log.OGPaidAmount))
                    }}
                  </td>
                  <td class="v-align text-right">
                    {{ isNull(log.OGBalance) ? "-" : toMoney(parseFloat(log.OGBalance)) }}
                  </td>
                  <td class="v-align text-right">
                    {{
                      isNull(log.NewTotalPayable)
                        ? "-"
                        : toMoney(parseFloat(log.NewTotalPayable))
                    }}
                  </td>
                  <td class="v-align text-right">
                    {{
                      isNull(log.NewPaidAmount)
                        ? "-"
                        : toMoney(parseFloat(log.NewPaidAmount))
                    }}
                  </td>
                  <td class="v-align text-right">
                    {{
                      isNull(log.NewBalance) ? "-" : toMoney(parseFloat(log.NewBalance))
                    }}
                  </td>
                </tr>
              </tbody>
  ...
  <div
    ref="modalAllTransactions"
    class="modal fade"
    id="modal-all-transactions"
    aria-hidden="true"
    style="display: none"
  >
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <div>
            <h4 class="no-pads">Transaction Details</h4>
          </div>
        </div>
        <div class="modal-body table-responsive">
          <!-- items/particulars -->
...
export default {
  ...
  methods: {
    ...
    getAllTransactions() {
      axios
        .get(`${this.baseURL}/transactions/get-transaction-history`, {
          params: {
            StudentId: this.studentId,
          },
        })
    ...
    showTransactionDetails(id) {
      ...
      axios
        .get(`${this.baseURL}/transactions/fetch-transaction-details`, {
          params: {
            TransactionId: id,
          },
        })
    ...
    getDetailedTransactions() {
      axios
        .get(`${this.baseURL}/transactions/fetched-detailed-transactions-per-student`, {
          params: {
            StudentId: this.studentId,
          },
        })
