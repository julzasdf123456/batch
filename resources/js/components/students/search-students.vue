          ...
          <tbody>
            ...
            >
              <td @click="viewStudent(student.id)" class="v-align">
                ...
                <div
                  style="display: inline-block; height: inherit; vertical-align: middle"
                >
                  <strong>{{
                    student.LastName +
                    ", " +
                    student.FirstName +
                    (isNull(student.MiddleName) ? "" : " " + student.MiddleName + " ") +
              ...
              <td @click="viewStudent(student.id)" class="v-align">
                {{ isNull(student.Year) ? "-" : student.Year + " - " + student.Section }}
              </td>
              <td @click="viewStudent(student.id)" class="v-align">
                <span
                  ...
                  v-if="
                    ...
                    student.Year !== 'Grade 11' &&
                    student.Year !== 'Grade 12'
                  "
                  >ESC</span
                >
                <span
                  ...
                  v-if="
                    student.ESCScholar === 'Yes' &&
                    (student.Year === 'Grade 11') | (student.Year === 'Grade 12')
                  "
                  >VMS</span
                >
              </td>
              <td @click="viewStudent(student.id)" class="v-align">
                <span
                  class="badge bg-success"
                  v-if="
                    student.FromSchool === 'Public' &&
                    (student.Year === 'Grade 11') | (student.Year === 'Grade 12')
                  "
                  >From Public School</span
                >
              </td>
              <td class="v-align text-right">
                <div class="px-3" title="More Options" style="display: inline">
                  <a
                    ...
                    aria-expanded="false"
                    class="btn btn-sm btn-link-muted"
                  >
                  ...
                  <div class="dropdown-menu">
                    <a
                      class="dropdown-item"
                      :href="
                        baseURL + '/students/edit-student/' + student.id + '/student-view'
                      "
                      >Edit Student</a
                    >
                  </div>
