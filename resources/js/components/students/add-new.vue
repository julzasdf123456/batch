<template>
    <div class="row">
        <div class="col-lg-12 px-4">
            <span class="text-muted text-sm"><strong>NOTE: </strong> This module is for adding a student that's already been enrolled but is not in the class list. <br> This is <strong>NOT</strong> 
                intended for enrollment. If you want to enroll a student, go to the <a :href="baseURL + '/students/new-student'">Enrollment</a> menu instead.
            </span>
        </div>
        ...
        saveStudent() {
            if (this.isNull(this.lrn) | this.isNull(this.firstname) | this.isNull(this.lastname) | this.isNull(this.town) | this.isNull(this.barangay + '') | this.isNull(this.gender) | this.isNull(this.sitio)) {
                ...
                .then(response => {
                    ...
                    window.location.href = this.baseURL + '/students/add-new-to-class/' + studentId
                })
                .catch(error => {
