    ...
    <div class="row px-4">
        <div class="col-lg-12">
            <h4>
                ...
                ><span class="text-muted">{{ advisory.Year }} - </span
                >{{ advisory.Section }}
            </h4>
            ...
            <span
                class="text-muted"
                v-if="isNull(advisory.Track) ? false : true"
                >{{
            ...
            <span
                class="text-muted"
                v-if="isNull(advisory.Strand) ? false : true"
                >{{ isNull(advisory.Strand) ? "" : " • " }}</span
            >
            <span
                class="text-muted"
                v-if="isNull(advisory.Strand) ? false : true"
            ...
            <span
                class="text-muted"
                v-if="isNull(advisory.Semester) ? false : true"
                ><strong>{{
                    isNull(advisory.Semester)
                        ? ""
                        : " • " + advisory.Semester + " Sem"
                }}</strong></span
            >
            ...
            <br />
            <span
                class="text-muted text-xs mr-2 pointer"
                title="Male Students Count"
                ><i class="fas fa-venus mr-1"></i>{{ male.length }}</span
            >
            •
            <span
                class="text-muted text-xs ml-2 mr-2 pointer"
                title="Female Students Count"
                ><i class="fas fa-mars mr-1"></i>{{ female.length }}</span
            >
            •
            <span
                class="text-muted text-xs ml-2 pointer"
                title="Total Students Count"
                ><i class="fas fa-venus-mars mr-1"></i
                >{{ female.length + male.length }}</span
            >
            ...
            <div class="card shadow-none" style="height: 80vh">
                ...
                <div class="card-body table-responsive">
                    <p class="no-pads text-sm text-danger">
                        <strong>NOTE </strong> that by directly adding students
                        here, you are bypassing the enrollment processs, and
                        that students will not be collected any enrollment fees.
                    </p>
                    <div class="row mt-2">
                        <div class="col-lg-12">
                            <p class="no-pads text-sm text-muted pb-2">
                                Search Student
                            </p>
                            <input
                                type="text"
                        ...
                        <div class="col-lg-12 mt-3">
                            ...
                            >
                                <tbody>
                                    <tr
                                        v-for="student in studentResults.data"
                                        :key="student.id"
                                    >
                                        <td class="v-align">
                                            <strong>{{
        ...
        <div
            class="mt-3"
            :class="addStudentFormActive ? 'col-lg-8' : 'col-lg-12'"
        >
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a
                                :href="
                                    baseURL +
                                    '/classes/download-students/' +
                                    classId
                                "
                                class="dropdown-item"
                                title="Download in excel file format"
                                ><i class="fas fa-file-excel ico-tab-mini"></i
                                >Download Students</a
                            >
                            <a
                                :href="
                            ...
                            >
                                <i class="fas fa-award ico-tab-mini"></i
                                >Rankings
                            </button>
                            <button
                            ...
                            >
                                <i class="fas fa-print ico-tab-mini"></i
                                >Print/Download Report Card
                            </button>
                            <button class="dropdown-item" @click="stubConfig()">
                                <i class="fas fa-cogs ico-tab-mini"></i>Stub
                                Config
                            </button>
                            ...
                            >
                                <i class="fas fa-wrench ico-tab-mini"></i>Manage
                                Class
                            </button>
                            ...
                            <button
                                ...
                                "
                            >
                                <i class="fas fa-user ico-tab-mini"></i>Change
                                Adviser
                            </button>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            >
                                <a
                                    ...
                                    aria-selected="false"
                                    ><i
                                        class="fas fa-shield-alt ico-tab-mini"
                                    ></i
                                    >Misc. Tuition Payments</a
                                >
                            </li>
                        </ul>
                        ...
                        >
                            ...
                            >
                                <div class="mt-2">
                                    ...
                                    <a
                                        ...
                                        title="Print"
                                        ><i
                                            class="fas fa-print ico-tab-mini"
                                        ></i
                                        >Print Students List</a
                                    >
                                    ...
                                    <a
                                        ...
                                        title="Download in excel file format"
                                        ><i
                                            class="fas fa-download ico-tab-mini"
                                        ></i
                                        >Download Excel</a
                                    >
                                </div>
                                ...
                                <div
                                    class="pt-3 pb-2"
                                    v-if="selectionMode && viewedIn === 'admin'"
                                >
                                    ...
                                    >
                                        <i
                                            class="fas fa-random ico-tab-mini"
                                        ></i
                                    ...
                                    >
                                        <i
                                            class="far fa-check-circle ico-tab-mini"
                                        ></i
                                        >Mark Non-{{
                                            (advisory.Year === "Grade 11")
                                            | (advisory.Year === "Grade 12")
                                    ...
                                    >
                                        <i
                                            class="fas fa-user-lock ico-tab-mini"
                                        ></i
                                        >Mark from Private
                                    </button>
                                    <button
                                    ...
                                    >
                                        <i
                                            class="fas fa-user-check ico-tab-mini"
                                        ></i
                                        >Mark from Public
                                    </button>
                                    <button
                                    ...
                                    >
                                        <i
                                            class="fas fa-sign-in-alt ico-tab-mini"
                                        ></i
                                        >Enroll to 2nd Semester
                                    </button>
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                >
                                                    <i
                                                        class="fas fa-venus ico-tab-mini"
                                                    ></i
                                                    >Male Students
                                                </td>
                                            </tr>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <i
                                                                    class="fas fa-sign-out-alt ico-tab"
                                                                ></i
                                                                >Withdrawn
                                                            </button>
                                                            <button
                                                            ...
                                                            >
                                                                <i
                                                                    class="fas fa-times-circle ico-tab"
                                                                ></i
                                                                >Dropped Out
                                                            </button>
                                                            ...
                                                            >
                                                                <i
                                                                    class="fas fa-file-excel ico-tab"
                                                                ></i
                                                                >Download SF10
                                                            </button>
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    <i
                                                        class="fas fa-mars ico-tab-mini"
                                                    ></i
                                                    >Female Students
                                                </td>
                                            </tr>
                            ...
                            >
                                <div class="container">
                                    <div class="row">
                                        ...
                                        >
                                            <div
                                                class="row g-2 p-2 w-auto align-items-end"
                                            >
                                                <div class="col-auto">
                                                    <label
                                                        for="start-date"
                                ...
                                <div class="table-responsive mt-2">
                                    ...
                                    <div class="form-group float-right ml-2">
                                        ...
                                        >
                                            View
                                            <i
                                                class="fas fa-check-circle ico-tab-left-mini"
                                            ></i>
                                        </button>
                                        ...
                                        >
                                            Download SF2
                                            <i
                                                class="fas fa-file-excel ico-tab-left-mini"
                                            ></i>
                                        </button>
                                    </div>
                                    ...
                                    <!-- year -->
                                    <div
                                        class="form-group float-right ml-2"
                                        style="width: 130px"
                                    >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <i class="fas fa-cogs ico-tab-mini"></i
                                        >Stub Config
                                    </button>
                                    ...
                                    >
                                        ...
                                        >
                                            <i
                                                class="fas fa-plus ico-tab-mini"
                                            ></i
                                            >Add Subject
                                        </button>
                                    </div>
                                ...
                                <div
                                    ...
                                    "
                                >
                                    <p class="no-pads text-sm text-muted">
                                        Grading View Options:
                                    </p>
                                    <button
                                        class="btn btn-xs"
                                        ...
                                        v-if="
                                            isNull(advisory.Semester) |
                                                (advisory.Semester === '1st')
                                        "
                                        :class="
                                            viewOptionSelectedQ === '1st'
                                                ? 'btn-success'
                                                : 'btn-default'
                                        "
                                    >
                                    ...
                                    <button
                                        ...
                                        v-if="
                                            isNull(advisory.Semester) |
                                                (advisory.Semester === '2nd')
                                        "
                                        :class="
                                            viewOptionSelectedQ === '3rd'
                                                ? 'btn-success'
                                                : 'btn-default'
                                        "
                                    >
                                    ...
                                    <div class="col-lg-12 pt-3">
                                        <div class="btn-group float-right">
                                            <button
                                                ...
                                                "
                                                @click="
                                                    changeInputType('DROPDOWN')
                                                "
                                            >
                                                <i
                                                    class="fas fa-chevron-circle-down ico-tab-mini"
                                                ></i>
                                                Dropdown
                                            </button>
                                            <button
                                            ...
                                            >
                                                <i
                                                    class="fas fa-text-width ico-tab-mini"
                                                ></i
                                                >Input
                                            </button>
                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="v-align">
                                                        ...
                                                        and initiative in doing
                                                        tasks in school and in
                                                        the community
                                                    </td>
                                                    <td>
                                                        <select
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            ...
                                            >
                                                ...
                                                <td
                                                    class="text-right v-align text-primary"
                                                >
                                                    {{
                                                        isNull(
                                                            student.PayableData
                                                ...
                                                ></td>
                                                <td
                                                    class="text-right v-align text-danger"
                                                >
                                                    {{
                                                        isNull(
                                                            student.PayableData
                            ...
                            >
                                <div class="mt-2">
                                    <a
                                        :href="
                                            baseURL +
                                            '/students/print-inactive-students/' +
                                            classId
                                        "
                                        class="btn btn-link btn-link-muted"
                                        title="Print"
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    >
                        <i class="fas fa-check ico-tab-mini"></i>Transfer
                        Selection
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body table-responsive">
                    ...
                    <table
                        class="table table-hover table-sm table-bordered mt-2"
                    >
                        <thead>
                            <tr>
            ...
            <div class="modal-content">
                <div class="modal-body table-responsive">
                    ...
                    <span
                        >for
                        {{
                            moment(dateSelectedShown).format("MMMM DD, YYYY")
                        }}</span
                    >
                    ...
                    >
                        <tbody>
                            <tr v-for="attData in selectedAttData">
                                <td>
                                    {{
                                        moment(attData.created_at).format(
                                            "hh:mm A"
                                        )
                                    }}
                                </td>
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3">
                        ...
                        <ul class="list-group">
                            ...
                            >
                                {{ teacher.FullName }} -
                                {{ teacher.Designation }} - {{ teacher.Status }}
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    data() {
        ...
        return {
            ...
            teacherId: document
                ...
                .getAttribute("content"),
            syId: document
                .querySelector("meta[name='school-year-id']")
                .getAttribute("content"),
            classId: document
                .querySelector("meta[name='class-id']")
                .getAttribute("content"),
            token: document
            ...
            pmOutThreshold: document
                ...
                .getAttribute("content"),
            viewedIn: document
                .querySelector("meta[name='viewed-in']")
                .getAttribute("content"),
            school: document
                .querySelector("meta[name='school']")
                .getAttribute("content"),
            olvInput: document
                .querySelector("meta[name='olv-input']")
                .getAttribute("content"),
            male: [],
            female: [],
            advisory: {},
    ...
    methods: {
        ...
        getPaymentData(month, studentId) {
            ...
            if (this.isNull(dataFound)) {
                ...
                var bal = this.isNull(dataFound.Balance)
                    ? 0
                    : parseFloat(dataFound.Balance);
                    ...
                    if (this.isNull(dataFound.AmountPaid)) {
                        ...
                        return (
                            ...
                            (this.isNull(dataFound)
                                ...
                                ? "-"
                                : this.toMoney(
                                      parseFloat(dataFound.AmountPaid)
                                  )) +
                            `</strong>` +
                            `<br><span class='text-sm text-muted'>Bal: ` +
                            bal +
        ...
        getSubjectData() {
            ...
            axios
                .get(
                    `${this.baseURL}/users/get-student-subjects-data-from-class`,
                    {
                        params: {
                            ClassId: this.classId,
                        },
        ...
        processedSubjects() {
            ...
            this.subjects.forEach((subject) => {
                if (subject.ParentSubject === null) {
                    ...
                    groupedSubjects[subject.ParentSubject].push(
                        subject.Subject
                    );
        ...
        getFinalGrade(studentId, subjectId, teacherid) {
            ...
            if (!this.isNull(gradeData)) {
                ...
                return this.isNull(displayGrade)
                    ? "-"
        ...
        getDaysInMonth() {
            const days = moment(
                this.attendanceYear + "-" + this.attendanceMonth
            ).daysInMonth();
        ...
        getBarcodeAttendances() {
            axios
                .get(
                    `${this.baseURL}/barcode_attendances/get-barcode-attendance-per-class`,
                    {
                        params: {
                            ClassId: this.classId,
                        },
        ...
        fetchDailyAttendance(studentId, date) {
            ...
            const inThreshold = moment(date + " 11:59").format(
                "YYYY-MM-DD HH:mm"
            );
            ...
            const outThreshold = moment(date + " 13:00").format(
                "YYYY-MM-DD HH:mm"
            );
        ...
        downloadSF2() {
            if (
                this.advisory.Year === "Grade 11" ||
                this.advisory.Year === "Grade 12"
            ) {
        ...
        removeFromClass(studentClassId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .delete(
                            `${this.baseURL}/studentClasses/` + studentClassId,
                            {
                                _token: this.token,
                                id: studentClassId,
                            }
            ...
            if (this.selection.length < 1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios
                            .post(
                                `${this.baseURL}/classes/mark-from-school-multiple`,
                                {
                                    _token: this.token,
                                    Students: this.selection,
                                    School: school,
        ...
        getMiscellaneousToTuitions() {
            axios
                .get(
                    `${this.baseURL}/classes/get-miscellaneous-to-tuitions-data`,
                    {
                        params: {
                            ClassId: this.classId,
                        },
        ...
        flushToTuitionData() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .post(
                            `${this.baseURL}/classes/flush-misc-to-tuitions`,
                            {
                                _token: this.token,
                                ClassId: this.classId,
                            }
        ...
        flushToEnrollmentData() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .post(
                            `${this.baseURL}/classes/flush-misc-enrollment-to-tuitions`,
                            {
                                _token: this.token,
                                ClassId: this.classId,
                            }
                ...
                .then((response) => {
                    ...
                    if (!this.isNull(this.subjectRepos)) {
                        this.subjectRepos = this.subjectRepos.filter(
                            (obj) =>
                                !this.subjects.some(
                                    (excludeObj) => excludeObj.id === obj.id
                                )
                        );
                    }
                })
        ...
        clearSubjects(studentId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .post(
                            `${this.baseURL}/classes/clear-student-subjects`,
                            {
                                StudentId: studentId,
                                ClassId: this.classId,
                                _token: this.token,
        ...
        getTotalAverage(studentId, grading) {
            let gradeData = this.subjectData.filter(
                (obj) =>
                    obj.StudentId === studentId &&
                    !this.homeroomSubjects.includes(obj.SubjectId)
            );
        ...
        sortRanking(grading) {
            ...
            if (grading === "First") {
                this.rankingData.sort(
                    (a, b) => b.FirstGradingGrade - a.FirstGradingGrade
                );
                this.activeRankTitle = grading + " Grading Rankings";
            } else if (grading === "Second") {
                this.rankingData.sort(
                    (a, b) => b.SecondGradingGrade - a.SecondGradingGrade
                );
                this.activeRankTitle = grading + " Grading Rankings";
            } else if (grading === "Third") {
                this.rankingData.sort(
                    (a, b) => b.ThirdGradingGrade - a.ThirdGradingGrade
                );
                this.activeRankTitle = grading + " Grading Rankings";
            } else if (grading === "Fourth") {
                this.rankingData.sort(
                    (a, b) => b.FourthGradingGrade - a.FourthGradingGrade
                );
                this.activeRankTitle = grading + " Grading Rankings";
            } else {
                this.rankingData.sort(
            ...
            if (
                    ...
                    preConfirm: () => {
                        ...
                        if (!selectedOption) {
                            Swal.showValidationMessage(
                                "You need to select an semester!"
                            );
                            return null;
                        }
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        ...
                        if (!selectedOption) {
                            Swal.showValidationMessage(
                                "You need to select an grading period!"
                            );
                            return null;
                        }
        ...
        runCheckEnrollableTo2ndSem() {
            if (
                ...
                if (
                    !this.isNull(this.advisory.Semester) &&
                    this.advisory.Semester === "1st"
                ) {
            ...
            if (this.selection.length < 1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios
                            .post(
                                `${this.baseURL}/classes/save-enroll-to-second-sem`,
                                {
                                    _token: this.token,
                                    Students: this.selection,
                ...
                if (this.isNull(classOther)) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            axios
                                .post(
                                    `${this.baseURL}/classes/create-new-sem`,
                                    {
                                        _token: this.token,
        ...
        toggleAddStudentsForm() {
            this.addStudentFormActive = this.addStudentFormActive
                ? false
                : true;
        },
                ...
                if (
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            ...
                            if (!selectedOption) {
                                Swal.showValidationMessage(
                                    "You need to select which side to print!"
                                );
                                return null;
                            }
                            return selectedOption.value;
            ...
            axios
                ...
                .then((response) => {
                    ...
                    if (!this.isNull(this.observedValues)) {
                        ...
                        this.makakalikasan_1 = this.findValue(
        ...
        confirmChangeAdviser() {
            if (
                window.confirm("Are you sure you want to change the adviser?")
            ) {
                this.changeAdviser();
            }
        },
        ...
        handleSubmitAttendance() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        title: "Submitting...",
                        text: "Please wait while we process the attendance.",
