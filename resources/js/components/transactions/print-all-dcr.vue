<template>
    ...
    <h3 class="no-pads text-center">Collection Report</h3>
...
export default {
    ...
    data() {
        return {
            ...
            to : document.querySelector("meta[name='to']").getAttribute('content'),
    ...
    methods : {
        ...
        async fetchAllData() {
            const dcr = axios.get(`${ this.baseURL }/transactions/fetch-payments-from-range`, {
                params : {
                    From : this.from,
                    To : this.to,
                    UserId: this.userId,
            ...
            console.log(response1.data.Payments)
