...
export default {
  ...
  methods: {
    ...
    fetchPayments() {
      // FETCH SUMMARY
      axios
        .get(`${this.baseURL}/transactions/fetch-admin-payments`, {
          params: {
            From: this.from,
            To: this.to,
      ...
      // FETCH DETAILS
      axios
        .get(`${this.baseURL}/transactions/fetch-all-admin-transaction-details`, {
          params: {
            From: this.from,
            To: this.to,
            Cashier: this.cashier,
    ...
    getCashiers() {
      axios
        .get(`${this.baseURL}/transactions/get-cashiers`)
        .then((response) => {
